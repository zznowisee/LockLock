...
public class Train : MonoBehaviour
{
    ...
    public void Setup(NormalNode startNode, int index)
    {
    ...
    IEnumerator MoveToTarget(NormalNode nextNode)
    {
    ...
    IEnumerator RotateToTarget(NormalNode nextNode)
    {
        Vector2 target = nextNode.transform.position;
