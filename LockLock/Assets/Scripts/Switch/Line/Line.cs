...
public class Line : MonoBehaviour
{
    ...
    public NormalNode StartNode { get { return lineInfo.startNode; } }
...
public class LineInfo
{
    ...
    public bool IsTwoNodeInSameLine(WayPointNode wayPointNode, NormalNode other)
    {
    ...
    public NormalNode GetNextNodeFromWayPoint(WayPointNode wayPointNode, NormalNode preNode)
    {
