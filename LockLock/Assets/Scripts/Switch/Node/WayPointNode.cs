...
public class WayPointNode : NormalNode
{
    ...
    public override Line GetLineFromConnectingNodesWithNode(NormalNode node)
    {
        for (int i = 0; i < lineInfos.Count; i++)
        {
    ...
    public override NormalNode GetNextNode(NormalNode preNode, NormalNode lineEnterNode)
    {
