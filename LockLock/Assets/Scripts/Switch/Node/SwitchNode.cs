...
public class SwitchNode : NormalNode
{
    ...
    public override void FinishDraw(ref NormalNode nextNode)
    {
    ...
    public override void Connect(ref NormalNode connectNode)
    {
...
/*        for (int i = 0; i < lineInfo.wayPointNodes.Count; i++)
    ...
    public override void Disconnect(ref NormalNode deleteNode, Line line)
    {
    ...
    public void SwitchByCombineNode(ref List<Line> changedLines, ref List<NormalNode> changedNodes)
    {
